...
constexpr LoraTrainingPreset
lora_training_preset(LoraTrainingStrength strength) noexcept {
  switch (strength) {
  case LoraTrainingStrength::ultra_low:
    return {1e-8, 1};
  case LoraTrainingStrength::medium:
    return {3e-6, 2};
